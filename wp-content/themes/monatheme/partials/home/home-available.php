...
<div id="<?php echo $args['id'] ?>" class="<?php echo $args['classes'] ?> proh section">
    <div class="container">
        <div class="proh-wrap">
            ...
            ?>
            <h2 class="t-title text-center fw-6 mb-40 text-effect"><?php echo $mona_home_section_available['available_title']; ?></h2>

            <div class="proh-ct d-wrap">
                <div class="proh-left d-item" data-aos="zoom-in" data-aos-delay="300">
                    <div class="proh-side">
                        <?php
                        // Lấy sản phẩm nổi bật
                        $available_p_featured = $mona_home_section_available['available_p_featured'];
                        $featured_p_id       = $available_p_featured['featured_p_id'][0];
                ...
                <div class="proh-right d-item">
                    <?php
                    if (!$mona_home_section_available['available_type_checked']) :
                        ...
                        $available_p_ids = $mona_home_section_available['available_p_ids'];
                        if ($available_p_ids) :
                            $args = array(
                                'post__in' => $available_p_ids,
                                'post_type' => 'product',
                                'numberposts' => -1,
                                'posts_per_page' => -1,
                                'orderby' => 'post__in',
                    ...
                    <?php
                    if (!$mona_home_section_available['available_type_checked']) {
                        $btn_href = get_category_link($available_p_cat);
                    } else {
                        $btn_href = $mona_home_section_available['available_btn_url'];
                    }
                    ?>
