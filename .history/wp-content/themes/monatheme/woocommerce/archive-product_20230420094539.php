							...
							<div class="swiper-wrapper">
								<div class="swiper-slide d-4">
									<div class="procate-item d-item">
										<a href="<?php echo get_permalink(MONA_WC_PRODUCTS); ?>" class="procate-item-wrap">
											<span class="procate-item-img">
												<img src="<?php echo get_site_url(); ?>/template/assets/images/cate-1.png" alt="">
											</span>
			...
			<div class="prolist-wrap d-wrap">
								...
								<div class="side-fixed-wrap filterJs">
									<div class="sidebar-wrap">
										...
										<div class="sidebar-top">
											<p class="sidebar-tit t-white upper fw-7">
												<span class="icon">
													<img src="<?php echo get_site_url(); ?>/template/assets/images/filter-icon.svg" alt="">
												</span>
										...
										<div class="sidebar-wrap-ct">
											...
											<ul class="cate-list recheck-block mb-24">
												<?php foreach ($checkboxes as $checkbox) : ?>
													<li class="cate-item recheck-item">
														...
														?>
														<input type="radio" <?php echo $is_check ? 'checked' : '' ?> name="product-option" value="<?php echo $checkbox['value']; ?>" hidden="" class="recheck-input">
													...
													<div class="ranges">
														<div class="range">
															...
															<div class="range-input mb-24">
																<input type="range" class="range-min" name="min" step="500000" min="0" max="10000000" value="<?php echo esc_attr($min_price); ?>">
																<input type="range" class="range-max" name="max" step="500000" min="0" max="10000000" value="<?php echo esc_attr($max_price); ?>">
															</div>
											...
											<ul class="cate-list star-rate recheck-block mb-24">
												...
												?>
													<li class="cate-item recheck-item">
														<input type="radio" <?php echo $isActive ? ' checked' : '' ?> name="star-rating" value="<?php echo $star['rating'] ?>" hidden class="recheck-input">
															...
															<div class="star">
																<div class="star-list">
																	<div class="star-flex star-empty">
																		<?php for ($i = 1; $i <= 5; $i++) : ?>
																			<img src="<?php echo get_site_url() ?>/template/assets/images/star-opa.svg" alt="" class="icon">
																		<?php endfor ?>
																	</div>
																	<div class="star-flex star-filter" style="width: <?php echo ($star['fill'] * 20) ?>%">
																		<?php for ($i = 1; $i <= $star['fill']; $i++) : ?>
																			<img src="<?php echo get_site_url() ?>/template/assets/images/star-fill.svg" alt="" class="icon">
																		<?php endfor ?>
																	</div>
																</div>
															</div>
											...
											<ul class="cate-list recheck-block mb-32">
												...
												?>
													<li class="cate-item recheck-item">
														<input type="radio" name="shipping" value="<?php echo $value; ?>" hidden="" class="recheck-input" <?php echo $checked; ?>>
														<span class="box">
															<i class="ti-check"></i>
														</span>
				...
				<div class="prolist-right d-item" id="mona-list-product">
					<div class="prolist-top mb-16 d-wrap flex-jc-between flex-ai-center">
						<div class="result d-item"><?php echo __('Đang hiển thị', 'monamedia'); ?> <span class="num fw-7"><?php echo $loop->found_posts ?></span> <?php echo __('kết quả', 'monamedia'); ?>
						</div>
